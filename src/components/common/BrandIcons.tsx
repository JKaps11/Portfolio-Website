...
/**
 * Brand marks, kept locally because lucide 1.0 removed every brand icon.
 * Paths are the canonical Simple Icons glyphs; they render in currentColor so
 * they inherit theme colours the same way lucide icons do.
 */

interface BrandIconProps extends Omit<SVGProps<SVGSVGElement>, "children"> {
    /** Matches lucide's `size` prop so these drop into the same call sites. */
    size?: number | string;
}
