...
export const MyJobs: WorkExperience[] = [
    {
        ...
        description: `• Developed full-stack web applications using AWS, NestJS, Next.js, and React, designing and integrating RESTful APIs, front-end interfaces, and cloud-based infrastructure.
        • Collaborated daily in an Agile environment, participating in stand-ups, sprint planning, and code reviews to ensure rapid, iterative delivery of features.
        • Maintained and enhanced a complex web form with extensive business logic, processing over 11,000 user requests per month while ensuring high reliability and performance.`,
